...
class AddToPlaylistAdapter(private val clickListener: (Playlist) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = AddToPlaylistViewHolder(
        ItemAddToPlaylistBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    )
    ...
    inner class AddToPlaylistViewHolder(private val binding: ItemAddToPlaylistBinding) :
